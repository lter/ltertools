...
microbenchmark::microbenchmark(
  ...
  # Old Version
  old_harmony <- ltertools::harmonize(key = key_obj, raw_folder = file.path("dev", "test-data"),
                                      data_format = "csv", quiet = F),
  
  # New version
  new_harmony <- harm_v2(key = key_obj, raw_folder = file.path("dev", "test-data"),
                         data_format = "csv", quiet = F),
...
## Row order: old / CRAN version vs. version 2
